...
Dtype SGDSolver<Dtype>::GetLearningRate() {
  ...
  } else if (lr_policy=="square"){
      int policy_interval=this->param_.lr_policy_interval();
      int policy_iter=this->param_.lr_policy_iter();
      int itr=this->iter_%(policy_interval+policy_iter);
      if(itr<policy_iter){
	    rate=this->param_.max_lr();
      }
      else{
	    rate=this->param_.base_lr();
      }
